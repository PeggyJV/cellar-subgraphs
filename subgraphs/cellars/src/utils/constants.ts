...
export const ETH_GROWTH =
  "0x6c51041a91c91c86f3f08a72cb4d3f67f1208897".toLowerCase();

export const CELLAR_ONE_SHARE_MAPPING = new Map<string, BigInt>();
CELLAR_ONE_SHARE_MAPPING.set(CELLAR_AAVE_LATEST, ONE_BI.times(TEN_BI.pow(18)));
CELLAR_ONE_SHARE_MAPPING.set(CELLAR_CLEARGATE_A, ONE_BI.times(TEN_BI.pow(18)));
CELLAR_ONE_SHARE_MAPPING.set(CELLAR_CLEARGATE_B, ONE_BI.times(TEN_BI.pow(18)));
CELLAR_ONE_SHARE_MAPPING.set(CELLAR_CLEARGATE_C, ONE_BI.times(TEN_BI.pow(18)));
CELLAR_ONE_SHARE_MAPPING.set(CELLAR_CLEARGATE_D, ONE_BI.times(TEN_BI.pow(18)));
CELLAR_ONE_SHARE_MAPPING.set(STEADY_BTC, ONE_BI.times(TEN_BI.pow(18)));
CELLAR_ONE_SHARE_MAPPING.set(STEADY_ETH, ONE_BI.times(TEN_BI.pow(18)));
CELLAR_ONE_SHARE_MAPPING.set(STEADY_UNI, ONE_BI.times(TEN_BI.pow(18)));
CELLAR_ONE_SHARE_MAPPING.set(STEADY_MATIC, ONE_BI.times(TEN_BI.pow(18)));
CELLAR_ONE_SHARE_MAPPING.set(REAL_YIELD_USD, ONE_BI.times(TEN_BI.pow(18)));
CELLAR_ONE_SHARE_MAPPING.set(REAL_YIELD_ETH, ONE_BI.times(TEN_BI.pow(18)));
CELLAR_ONE_SHARE_MAPPING.set(REAL_YIELD_LINK, ONE_BI.times(TEN_BI.pow(18)));
CELLAR_ONE_SHARE_MAPPING.set(REAL_YIELD_1INCH, ONE_BI.times(TEN_BI.pow(18)));
CELLAR_ONE_SHARE_MAPPING.set(REAL_YIELD_UNI, ONE_BI.times(TEN_BI.pow(18)));
CELLAR_ONE_SHARE_MAPPING.set(REAL_YIELD_SNX, ONE_BI.times(TEN_BI.pow(18)));
CELLAR_ONE_SHARE_MAPPING.set(REAL_YIELD_ENS, ONE_BI.times(TEN_BI.pow(18)));
CELLAR_ONE_SHARE_MAPPING.set(DEFI_STARS, ONE_BI.times(TEN_BI.pow(18)));
CELLAR_ONE_SHARE_MAPPING.set(FRAXIMAL, ONE_BI.times(TEN_BI.pow(18)));
CELLAR_ONE_SHARE_MAPPING.set(REAL_YIELD_BTC, ONE_BI.times(TEN_BI.pow(18)));
CELLAR_ONE_SHARE_MAPPING.set(TURBO_SWETH, ONE_BI.times(TEN_BI.pow(18)));
CELLAR_ONE_SHARE_MAPPING.set(TURBO_GHO, ONE_BI.times(TEN_BI.pow(6)));
CELLAR_ONE_SHARE_MAPPING.set(ETH_GROWTH, ONE_BI.times(TEN_BI.pow(6)));
...
CELLAR_START.set(ETH_GROWTH, BigInt.fromI32(18144591));
